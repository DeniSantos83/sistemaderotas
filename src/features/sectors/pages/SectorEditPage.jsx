  ...
  useEffect(() => {
    async function loadSector() {
      try {
        ...
        setError(err.message || "Erro ao carregar setor.");
      } finally {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const payload = {
        ...
        location_reference: normalizeOptional(form.location_reference),
      ...
      setError(err.message || "Não foi possível atualizar o setor.");
    } finally {
      setSaving(false);
    }
  }
        ...
        <section style={styles.loadingCard}>
          ...
          <div>
            ...
            <p style={styles.loadingText}>
              Preparando dados para edição do setor...
            </p>
          </div>
        </section>
      </div>
      ...
      <section style={styles.heroCard}>
        ...
        <div style={styles.heroContent}>
          <div style={styles.heroBadge}>
            <Sparkles size={15} />
            <span>Edição premium de setor</span>
          </div>

          <h1 style={styles.heroTitle}>Editar setor</h1>

          <p style={styles.heroText}>
            Atualize as informações organizacionais do setor com um formulário
            moderno, limpo e consistente com o padrão SaaS do sistema.
          </p>
        ...
        <div style={styles.heroActions}>
          <Link to={`/setores/${id}`} style={styles.backButton}>
            <ArrowLeft size={17} />
            <span>Voltar</span>
          </Link>
        </div>
        ...
        <section style={styles.mainCard}>
          <div style={styles.cardHeader}>
            <div>
              ...
              <h2 style={styles.cardTitle}>Editar setor</h2>
              <p style={styles.cardText}>
                Atualize os dados principais do setor para manter a estrutura
                organizacional padronizada e bem documentada.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Dados centrais para reconhecer o setor no sistema.
                  </p>
                </div>
              </div>
              ...
              <div style={styles.fieldsGrid}>
                <div style={styles.fieldGroup}>
                  ...
                  <input
                    ...
                    placeholder="Ex.: Patrimônio, TI, Almoxarifado"
                    style={styles.input}
                  />
                </div>
            ...
            <div style={styles.sectionBlock}>
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Informações complementares para localização e situação do
                    setor.
                  </p>
                </div>
              </div>
              ...
              <div style={styles.fieldsGrid}>
                <div style={styles.fieldGroup}>
                  <label style={styles.label}>
                    <MapPin size={16} />
                    <span>Referência de local</span>
                  </label>
                  <input
                    type="text"
                    value={form.location_reference}
                    onChange={(e) =>
                      updateField("location_reference", e.target.value)
                    }
                    placeholder="Ex.: Prédio Sede - 2º Andar"
                    style={styles.input}
                  />
                </div>
            ...
            <div style={styles.sectionBlock}>
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Mantenha uma descrição útil sobre a função e finalidade do
                    setor.
                  </p>
                </div>
              </div>
              ...
              <div style={styles.fieldGroup}>
                <label style={styles.label}>
                  <FileText size={16} />
                  <span>Descrição do setor</span>
                </label>
                <textarea
                  rows={6}
                  value={form.description}
                  onChange={(e) => updateField("description", e.target.value)}
                  placeholder="Ex.: Setor responsável pelo controle patrimonial e movimentação de equipamentos."
            ...
            <div style={styles.formActions}>
              <Link to={`/setores/${id}`} style={styles.cancelButton}>
                Cancelar
              </Link>
        ...
        <aside style={styles.sideColumn}>
          <section style={styles.sideCard}>
            ...
            <div style={styles.summaryList}>
              ...
              <div style={styles.summaryItem}>
                ...
                <strong style={styles.summaryValue}>
                  {form.location_reference.trim() || "Não informada"}
                </strong>
              </div>
          ...
          <section style={styles.sideCardSoft}>
            ...
            <ul style={styles.tipList}>
              ...
              <li style={styles.tipItem}>
                Mantenha a referência de local preenchida para facilitar a
                identificação física.
              </li>
              <li style={styles.tipItem}>
                Marque como <strong>Inativo</strong> quando o setor não estiver
