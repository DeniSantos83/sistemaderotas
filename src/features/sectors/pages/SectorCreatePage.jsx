...
export default function SectorCreatePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError(err.message || "Não foi possível criar o setor.");
    } finally {
      setSaving(false);
    }
  }
      ...
      <section style={styles.heroCard}>
        ...
        <div style={styles.heroContent}>
          <div style={styles.heroBadge}>
            <Sparkles size={15} />
            <span>Cadastro premium de setor</span>
          </div>

          <h1 style={styles.heroTitle}>Novo setor</h1>

          <p style={styles.heroText}>
            Cadastre um novo setor para estruturar melhor sua operação,
            organizar equipamentos, vincular fluxos internos e manter a base do
            sistema padronizada em uma experiência SaaS premium.
          </p>
        ...
        <section style={styles.mainCard}>
          <div style={styles.cardHeader}>
            <div>
              ...
              <h2 style={styles.cardTitle}>Cadastrar setor</h2>
              <p style={styles.cardText}>
                Preencha os dados principais para adicionar um novo setor à
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Dados centrais para reconhecer o setor dentro do sistema.
                  </p>
                </div>
              </div>
            ...
            <div style={styles.sectionBlock}>
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Registre uma descrição útil sobre a função ou finalidade do
                    setor.
                  </p>
                </div>
              </div>
            ...
            <div style={styles.formActions}>
              <Link to="/setores" style={styles.cancelButton}>
                Cancelar
              </Link>
          ...
          <section style={styles.sideCardSoft}>
            ...
            <ul style={styles.tipList}>
              <li style={styles.tipItem}>
                Use nomes claros e consistentes para facilitar buscas e
                relatórios.
              </li>
              <li style={styles.tipItem}>
                Preencha o código do setor quando houver um padrão interno de
                identificação.
              </li>
              <li style={styles.tipItem}>
                Deixe como <strong>Ativo</strong> quando o setor estiver em uso
                normal na operação.
              </li>
            </ul>
          </section>
