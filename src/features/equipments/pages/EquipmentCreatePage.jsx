...
export default function EquipmentCreatePage() {
  ...
  useEffect(() => {
    async function bootstrapPage() {
      try {
        ...
        setError(err.message || "Erro ao preparar a página.");
      } finally {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError(err.message || "Não foi possível criar o equipamento.");
    } finally {
      setSaving(false);
    }
  }
        ...
        <section style={styles.loadingCard}>
          ...
          <div>
            ...
            <p style={styles.loadingText}>
              Carregando ambiente para cadastro do equipamento...
            </p>
          </div>
        </section>
      </div>
      ...
      <section style={styles.heroCard}>
        ...
        <div style={styles.heroContent}>
          <div style={styles.heroBadge}>
            <Sparkles size={15} />
            <span>Cadastro premium de ativo</span>
          </div>

          <h1 style={styles.heroTitle}>Novo equipamento</h1>

          <p style={styles.heroText}>
            Cadastre um novo equipamento com identificação operacional,
            patrimônio, número de série, marca, modelo e observações em um
            formulário mais limpo, robusto e com padrão visual SaaS premium.
          </p>
        ...
        <section style={styles.mainCard}>
          <div style={styles.cardHeader}>
            <div>
              ...
              <h2 style={styles.cardTitle}>Cadastrar equipamento</h2>
              <p style={styles.cardText}>
                Preencha os dados principais para adicionar um novo ativo ao
                inventário.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Informações base para reconhecer o equipamento no sistema.
                  </p>
                </div>
              </div>
            ...
            <div style={styles.sectionBlock}>
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Preencha dados de patrimônio, série, marca e modelo para
            ...
            <div style={styles.sectionBlock}>
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Registre informações adicionais relevantes sobre o ativo.
                  </p>
                </div>
              </div>
              ...
              <div style={styles.fieldGroup}>
                ...
                <textarea
                  ...
                  placeholder="Ex.: Equipamento destinado ao setor X, com carregador original e bolsa."
            ...
            <div style={styles.formActions}>
              <Link to="/equipamentos" style={styles.cancelButton}>
                Cancelar
              </Link>
          ...
          <section style={styles.sideCardSoft}>
            ...
            <ul style={styles.tipList}>
              <li style={styles.tipItem}>
                Use um nome claro e padronizado para facilitar a busca.
              </li>
              <li style={styles.tipItem}>
                Preencha tombamento e série sempre que disponíveis para melhorar
                o controle patrimonial.
              </li>
              <li style={styles.tipItem}>
                Mantenha o status como <strong>Ativo</strong> quando o
                equipamento estiver em uso normal no inventário.
              </li>
            </ul>
          </section>
        </aside>
