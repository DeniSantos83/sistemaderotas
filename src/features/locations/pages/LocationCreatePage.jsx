      ...
      <section style={styles.heroCard}>
        ...
        <div style={styles.heroContent}>
          <div style={styles.heroBadge}>
            <Sparkles size={15} />
            <span>Cadastro premium de local</span>
          </div>

          <h1 style={styles.heroTitle}>Novo local</h1>

          <p style={styles.heroText}>
            Cadastre um novo local para estruturar melhor a operação, organizar
            referências físicas e manter a base do sistema padronizada em uma
        ...
        <section style={styles.mainCard}>
          <div style={styles.cardHeader}>
            <div>
              ...
              <h2 style={styles.cardTitle}>Cadastrar local</h2>
              <p style={styles.cardText}>
                Preencha os dados principais para adicionar um novo local à
                estrutura física e operacional do sistema.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.sectionBlock}>
              <div style={styles.sectionBlockHeader}>
                ...
                <div>
                  ...
                  <p style={styles.subText}>
                    Registre uma descrição útil sobre o local, sua finalidade ou
            ...
            <div style={styles.formActions}>
              <Link to="/locais" style={styles.cancelButton}>
                Cancelar
              </Link>
        ...
        <aside style={styles.sideColumn}>
          ...
          <section style={styles.sideCardSoft}>
            ...
            <ul style={styles.tipList}>
              ...
              <li style={styles.tipItem}>
                Preencha o código do local quando houver um padrão interno de
                identificação.
              </li>
              <li style={styles.tipItem}>
                Deixe como <strong>Ativo</strong> quando o local estiver em uso
                normal na operação.
              </li>
            </ul>
          </section>
