...
export default function LocationDetailsPage() {
  ...
  async function loadLocation(showRefreshState = false) {
    try {
      setError("");
      ...
      setError(err.message || "Erro ao carregar os detalhes do local.");
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  const summary = useMemo(() => {
    ...
    return {
      ...
      code: safeText(location.code, "Não informado"),
      address: safeText(location.address, "Não informado"),
      status: getStatusLabel(Boolean(location.active)),
    };
  }, [location]);
        ...
        <section style={styles.loadingCard}>
          ...
          <div>
            ...
            <p style={styles.loadingText}>
              Preparando os detalhes completos do local...
            </p>
          </div>
        </section>
      </div>
      ...
      <div style={styles.page}>
        <section style={styles.mainCard}>
          <div style={styles.errorBox}>
            Local não encontrado ou indisponível.
          </div>
      ...
      <section style={styles.heroCard}>
        ...
        <div style={styles.heroContent}>
          <div style={styles.heroBadge}>
            <Sparkles size={15} />
            <span>Visualização premium do local</span>
          </div>

          <h1 style={styles.heroTitle}>{safeText(location.name)}</h1>

          <p style={styles.heroText}>
            Consulte os dados do local, acompanhe o status atual, visualize
            código, endereço e descrição e gerencie a estrutura física da
            operação em uma interface SaaS premium.
          </p>
          ...
          <div style={styles.heroMetrics}>
            <div style={styles.heroMetricItem}>
              ...
              <strong style={styles.heroMetricValue}>
                {safeText(location.code, "Não informado")}
              </strong>
            </div>
            ...
            <div style={styles.heroMetricItem}>
              <span style={styles.heroMetricLabel}>Endereço</span>
              <strong style={styles.heroMetricValue}>
                {safeText(location.address, "Não informado")}
              </strong>
            </div>
            ...
            <div style={styles.heroMetricItem}>
              ...
              <strong style={styles.heroMetricValue}>
                {getStatusLabel(Boolean(location.active))}
              </strong>
            </div>
          </div>
        </div>
        ...
        <div style={styles.heroActions}>
          <Link to="/locais" style={styles.backButton}>
            <ArrowLeft size={17} />
            <span>Voltar</span>
          </Link>

          <Link to={`/locais/${location.id}/editar`} style={styles.primaryButton}>
            <Pencil size={17} />
        ...
        <section style={styles.mainCard}>
          <div style={styles.cardHeader}>
            <div>
              ...
              <h2 style={styles.cardTitle}>Informações do local</h2>
              <p style={styles.cardText}>
                Visualize os dados principais do local em um painel limpo,
          ...
          <div style={styles.infoGrid}>
            ...
            <article style={styles.infoCard}>
              ...
              <div style={styles.infoContent}>
                <span style={styles.infoLabel}>Endereço / referência</span>
                <strong style={styles.infoValue}>
                  {safeText(location.address, "Não informado")}
                </strong>
            ...
            <article style={styles.infoCard}>
              ...
              <div style={styles.infoContent}>
                ...
                <strong style={styles.infoValue}>
                  <span style={getStatusStyle(Boolean(location.active))}>
                    {getStatusLabel(Boolean(location.active))}
                  </span>
                </strong>
                <span style={styles.infoSubtle}>Situação atual do local</span>
              </div>
            </article>
          </div>
        </section>
          ...
          <section style={styles.sideCard}>
            ...
            <div style={styles.summaryList}>
              ...
              <div style={styles.summaryItem}>
                ...
                <strong style={styles.summaryValue}>{summary.address}</strong>
              </div>
          ...
          <section style={styles.sideCardSoft}>
            ...
            <div style={styles.sideActions}>
              ...
              >
                ...
                <span>
                  {location.active ? "Marcar como inativo" : "Marcar como ativo"}
                </span>
              </button>
      ...
      <section style={styles.mainCard}>
        <div style={styles.cardHeader}>
          <div>
            ...
            <h2 style={styles.cardTitle}>Dados completos do local</h2>
            <p style={styles.cardText}>
              Visualize informações técnicas, auditoria e descrição do local.
            </p>
          </div>
        </div>
        ...
        <div style={styles.detailsGrid}>
          ...
          <div style={styles.detailBlock}>
            ...
            <div style={styles.detailList}>
              ...
              <div style={styles.detailItem}>
                <span style={styles.detailLabel}>Endereço</span>
                <strong style={styles.detailValue}>
                  {safeText(location.address, "Não informado")}
                </strong>
              </div>
          ...
          <div style={styles.detailBlock}>
            ...
            <div style={styles.detailList}>
              <div style={styles.detailItem}>
                ...
                <strong style={styles.detailValue}>{safeText(location.id)}</strong>
              </div>
          ...
          <div style={styles.detailBlock}>
            ...
            <p style={styles.notesText}>
              {safeText(
                ...
                "Nenhuma descrição cadastrada para este local."
              )}
            </p>
          </div>
        </div>
