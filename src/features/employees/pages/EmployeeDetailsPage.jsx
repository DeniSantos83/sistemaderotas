...
export default function EmployeeDetailsPage() {
  ...
  async function loadEmployee(showRefreshState = false) {
    try {
      setError("");
      ...
      setError(err.message || "Erro ao carregar os detalhes do colaborador.");
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  const summary = useMemo(() => {
    ...
    return {
      ...
      registration: safeText(employee.registration, "Não informada"),
      employeeType: safeText(employee.employee_type, "Não definido"),
      status: getStatusLabel(Boolean(employee.active)),
    };
  }, [employee]);
        ...
        <section style={styles.loadingCard}>
          ...
          <div>
            ...
            <p style={styles.loadingText}>
              Preparando os detalhes completos do colaborador...
            </p>
          </div>
        </section>
      </div>
      ...
      <div style={styles.page}>
        <section style={styles.mainCard}>
          <div style={styles.errorBox}>
            Colaborador não encontrado ou indisponível.
          </div>
      ...
      <section style={styles.heroCard}>
        ...
        <div style={styles.heroContent}>
          <div style={styles.heroBadge}>
            <Sparkles size={15} />
            <span>Visualização premium do colaborador</span>
          </div>

          <h1 style={styles.heroTitle}>{safeText(employee.name)}</h1>

          <p style={styles.heroText}>
            Consulte os dados do colaborador, acompanhe o status atual,
            visualize matrícula, perfil e contatos e gerencie sua base
            operacional em uma interface SaaS premium.
          </p>
          ...
          <div style={styles.heroMetrics}>
            <div style={styles.heroMetricItem}>
              ...
              <strong style={styles.heroMetricValue}>
                {safeText(employee.registration, "Não informada")}
              </strong>
            </div>
            ...
            <div style={styles.heroMetricItem}>
              <span style={styles.heroMetricLabel}>Tipo / Cargo</span>
              <strong style={styles.heroMetricValue}>
                {safeText(employee.employee_type, "Não definido")}
              </strong>
            </div>
            ...
            <div style={styles.heroMetricItem}>
              ...
              <strong style={styles.heroMetricValue}>
                {getStatusLabel(Boolean(employee.active))}
              </strong>
            </div>
          </div>
        </div>
        ...
        <div style={styles.heroActions}>
          ...
          <Link
            to={`/colaboradores/${employee.id}/editar`}
        ...
        <section style={styles.mainCard}>
          <div style={styles.cardHeader}>
            <div>
              ...
              <h2 style={styles.cardTitle}>Informações do colaborador</h2>
              <p style={styles.cardText}>
                Visualize os dados principais do colaborador em um painel limpo,
          ...
          <div style={styles.infoGrid}>
            ...
            <article style={styles.infoCard}>
              ...
              <div style={styles.infoContent}>
                <span style={styles.infoLabel}>Tipo / Cargo</span>
                <strong style={styles.infoValue}>
                  {safeText(employee.employee_type, "Não definido")}
                </strong>
                <span style={styles.infoSubtle}>Perfil operacional</span>
              </div>
            </article>
            ...
            <article style={styles.infoCard}>
              ...
              <div style={styles.infoContent}>
                ...
                <strong style={styles.infoValue}>
                  <span style={getStatusStyle(Boolean(employee.active))}>
                    {getStatusLabel(Boolean(employee.active))}
                  </span>
                </strong>
                <span style={styles.infoSubtle}>Situação atual do colaborador</span>
              </div>
            </article>
          </div>
        </section>
        ...
        <aside style={styles.sideColumn}>
          <section style={styles.sideCard}>
            ...
            <div style={styles.summaryList}>
              ...
              <div style={styles.summaryItem}>
                ...
                <strong style={styles.summaryValue}>{summary.registration}</strong>
              </div>

              <div style={styles.summaryItem}>
                <span style={styles.summaryLabel}>Tipo / Cargo</span>
                <strong style={styles.summaryValue}>{summary.employeeType}</strong>
              </div>
          ...
          <section style={styles.sideCardSoft}>
            ...
            <div style={styles.sideActions}>
              ...
              >
                <Pencil size={16} />
                <span>Editar este colaborador</span>
              </Link>
            </div>
          </section>
        </aside>
      ...
      <section style={styles.mainCard}>
        <div style={styles.cardHeader}>
          <div>
            ...
            <h2 style={styles.cardTitle}>Dados completos do colaborador</h2>
            <p style={styles.cardText}>
              Visualize informações cadastrais, contatos, auditoria e observações.
            </p>
          </div>
        </div>
        ...
        <div style={styles.detailsGrid}>
          ...
          <div style={styles.detailBlock}>
            ...
            <div style={styles.detailList}>
              <div style={styles.detailItem}>
                <span style={styles.detailLabel}>Tipo / Cargo</span>
                <strong style={styles.detailValue}>
                  {safeText(employee.employee_type, "Não definido")}
                </strong>
              </div>
              ...
              <div style={styles.detailItem}>
                ...
                <strong style={styles.detailValue}>
                  {safeText(employee.phone, "Não informado")}
                </strong>
              </div>
              ...
              <div style={styles.detailItem}>
                ...
                <strong style={styles.detailValue}>
                  {safeText(employee.email, "Não informado")}
                </strong>
              </div>
            </div>
          </div>
          ...
          <div style={styles.detailBlock}>
            ...
            <div style={styles.detailList}>
              <div style={styles.detailItem}>
                ...
                <strong style={styles.detailValue}>{safeText(employee.id)}</strong>
              </div>
          ...
          <div style={styles.detailBlock}>
            ...
            <p style={styles.notesText}>
              {safeText(
                employee.notes,
                "Nenhuma observação cadastrada para este colaborador."
              )}
            </p>
          </div>
        </div>
